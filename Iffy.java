public class Iffy {
   ...
   public void callSomeMethods() {
	  ...
	  resetIfNegative(anIntProp);
	  System.out.println(isInRange(21, 20, 10));
	  System.out.println(isInRangeIfLess(21, 20, 10));
   }
   ...
   public boolean isInRangeIfLess(int value, int upperBound, int lowerBound) {
     return Math.abs(value - lowerBound) + Math.abs(upperBound - value) == Math.abs(upperBound - lowerBound);
